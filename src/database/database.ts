...
class DataBase {
    ...
    public _cadenaConexion: string = 'mongodb://localhost/Hospital'
    public _cadenaConexion2: string = 'mongodb+srv://jairo:1234@cluster0.dynye.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
    constructor(){
